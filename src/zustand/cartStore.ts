...
interface CartState {
  ...
  addToCart: (item: Omit<CartItem, "quantity">) => void; //Take the CartItem interface, but remove the quantity property. Quantity omitted bcz initially only 1 is set, rest is handles by other reducer.
