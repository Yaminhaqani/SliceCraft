...
<Link to="/menu">
         <motion.button className="absolute px-0.5 top-23 left-2 bg-transparent border tracking-tight text-sm font-light text-white rounded-sm shadow-md hover:shadow-gray-500/60 cursor-pointer sm:top-29 sm:text-md"
